...
{
    public partial class frmL_Profile : Form
    {
        ...
        public frmL_Profile(string userName, string pass)
        {
            InitializeComponent();
            username = userName;
            password = pass;
        ...
        private void FrmProfile_Load(object sender, EventArgs e)
        {
            ...
            if (reader.Read())
            {
                ...
                if (retrievedUsername == username)
                {
                    ...
                    string imagePath = "C:\\Users\\Asus\\OneDrive - Asia Pacific University\\Desktop\\Projects\\IOOP Group Assignment Final Code Compilation\\IOOP Assignment Profile\\lecturer.png";
        ...
        {
            string form = "home";
            LecturerDashboard obj = new LecturerDashboard(form, username);
            obj.redirect();
            this.Hide();
        }
